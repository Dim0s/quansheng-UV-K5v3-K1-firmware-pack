...
2. [KA52M](https://github.com/Dim0s/quansheng-UV-K5v3-K1-firmware-pack/tree/main/KA52M) - декодирование только через приложение UV AIR DROID, в рации можно набрать текст буквами и рация сама закодирует его в морзянку, или самому набивать морзянку кнопкой PTT
___
