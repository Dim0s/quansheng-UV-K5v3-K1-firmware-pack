...
#1.0.0:
#       remove one push
#       add SkipBD for birdie elimination
#       remove voltage in WELCOME_LIST
...
FIRMWARE_VERSION_UPDATE = "https://github.com/mentanah/uv-k1-k5v3-firmware-custom/releases"
...
# power          
UVK5_POWER_LEVELS = [chirp_common.PowerLevel("OFF", watts=0.000),
...
WELCOME_LIST = ["Message line 1, Voltage, Sound (ALL)", "Make 2 short sounds (SOUND)", "User message line 1 and line 2 (MESSAGE)", "NONE"]
...
# add menu firmware with version and option display if version 3.0 and up
        ValFirm = "Firmware: CALYPSO Edition" #+ self.FIRMWARE_VERSION 
        Compair1 = "F4HWN v4.0"  
        ...
        def validate_Go_Web_Firmware(value):
            if value :
                msg = "To see information for the update of the CALYPSO Firmware\n"
        ...
        rs = RadioSetting("Update_Firmware_mise_a_jour","To see information for the update of the CALYPSO Firmware, select this box ->", val)
        rs.set_doc('To see information for the update of the CALYPSO Firmware!')
...
# end add menu firmware with version and option display
        ...
        # SkipBD CALYPSO
        tmpsetptt = list_def(_mem.SkipBD, SkipBD_LIST, 0)
        val = RadioSettingValueList(SkipBD_LIST, SkipBD_LIST[tmpsetptt])
        SetPttSetting = RadioSetting("SkipBD", "Skip Birdies: skip birdies in VFO (SkipBD)", val)
        SetPttSetting.set_doc('SetPtt :\n' + \
                              '* OFF : no birdie frequency elimination.\n' + \
                              '* ON : all birdies are skipped on stepping or scanning through VFO.\n' + \
                              '       Birdies are all harmonics and non harmonic caused by internal.\n' + \
                              '       interference due to the crystal')
...
#       message box to the web page link (firmware)
        ...
        def validate_Go_Web_Page0(value):
            if value :
                msg = "Go to the web Page of the Firmware CALYPSO \n" \
