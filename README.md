...
1. [GOGU](https://github.com/Dim0s/quansheng-UV-K5v3-K1-firmware-pack/tree/main/GOGU) - удобный, простой, быстрый, FSK, ACK (первое место за то что сделан на базе последнего F4HWN)
2. [PrepperRadio](https://github.com/Dim0s/quansheng-UV-K5v3-K1-firmware-pack/tree/main/PrepperRadio) - сложный, туговат, FSK 1.2, FSK .6, FSK 2.4, FFSK 1.2, ACK, можно отправлять сообщения прям с компа
